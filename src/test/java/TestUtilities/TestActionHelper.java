...
import Utilities.WrapperException;
...
public class TestActionHelper {
	...
	public void typeIntoTextBox(By Locator,String text) {
	...
	public String getMessageTest(By Locator) {
		try {
			...
			return TestRetryMechanism.retryOnException(()->{
				...
				if(text!=null) {logger.info("Successfully get text from element: " + Locator);}
				return text;
			}, 2, StaleElementReferenceException.class, ElementClickInterceptedException.class,
                    NoSuchElementException.class);
